...
const InvoiceTemplate = (data: InvoiceWithEpcQrCode) => {
						...
						<div>
							<span className='font-semibold text-md text-gray-800'>
								...
								{details.paymentInformation?.iban && (
									<p className='text-sm'>IBAN: {details.paymentInformation.iban}</p>
								)}
								{details.paymentInformation?.bic && (
									<p className='text-sm'>BIC: {details.paymentInformation.bic}</p>
								)}
							</span>
						</div>
